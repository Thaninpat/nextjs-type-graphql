...
const JobRequestIt_1 = require("./resolvers/JobRequestIt");
const FactoryResolvers_1 = require("./resolvers/FactoryResolvers");
const tokenHandler_1 = require("./utils/tokenHandler");
const User_1 = require("./entities/User");
exports.default = async () => {
    const schema = await type_graphql_1.buildSchema({
        resolvers: [AuthResolvers_1.AuthResolvers, JobRequestIt_1.JobRequestIt, FactoryResolvers_1.FactoryResolvers],
