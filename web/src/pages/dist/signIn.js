...
var signIn = function () {
    ...
    }), signInMutation = _d[0], _e = _d[1], loading = _e.loading, error = _e.error;
    ...
    return (react_1["default"].createElement(Wrapper_1.Wrapper, { variant: 'small' },
        react_1["default"].createElement(react_2.Box, { d: 'flex', mt: '2', alignItems: 'center', justifyContent: 'center' },
            react_1["default"].createElement(react_2.Heading, { as: 'h2', size: 'xl' }, "Sign in")),
        react_1["default"].createElement("form", { onSubmit: submitSignin },
            ...
            react_1["default"].createElement(react_2.Box, { m: 0 },
                react_1["default"].createElement(react_2.Text, { as: 'sub', fontSize: 'md' },
                    ...
                    react_1["default"].createElement(link_1["default"], { href: '/signIn' },
                        react_1["default"].createElement("a", { style: { color: '#0366d6' } }, "Click")))),
            react_1["default"].createElement(react_2.Box, { m: 0 },
                react_1["default"].createElement(react_2.Text, { as: 'sub', fontSize: 'md' },
                    "New account?",
                    react_1["default"].createElement(link_1["default"], { href: '/signUp' },
                        react_1["default"].createElement("a", { style: { color: '#0366d6' } }, "Create account")))))));
};
