...
var signUp = function signUp() {
  ...
  var _d = graphql_1.useSignUpMutation(),
      signup = _d[0],
      _e = _d[1],
      loading = _e.loading,
      error = _e.error;
...
exports["default"] = signUp; // <div className={styles.container}>
